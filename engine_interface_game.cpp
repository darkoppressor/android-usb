...
/**")){
        ...
        //name else if(!multi_line_comment && boost::algorithm::starts_with(line,str_name)){
...
void Engine_Interface::render_title_background () {
    ...
    font->show(0, main_window.SCREEN_HEIGHT - font->spacing_y * 2.0,
    ...
    render_texture(main_window.SCREEN_WIDTH - logo->w * logo_scale_x,
                   main_window.SCREEN_HEIGHT - logo->h * logo_scale_y, *logo, 1.0, logo_scale_x, logo_scale_y);
}
...
void Engine_Interface::render_pause () {
    ...
    font->show((main_window.SCREEN_WIDTH - (font->spacing_x * msg.length())) / 2,
               (main_window.SCREEN_HEIGHT - font->spacing_y) / 2, msg, "ui_white");
}
...
void Engine_Interface::render_loading_screen (double percentage, string load_message) {
    ...
    render_rectangle(main_window.SCREEN_WIDTH / 2.0 - 120 - 2, main_window.SCREEN_HEIGHT - 75 - 2, max_bar_width + 4,
                     30 + 4, 1.0, "ui_3");
    ...
    font->show(main_window.SCREEN_WIDTH / 2.0 - 120 + (max_bar_width - msg.length() * font->spacing_x) / 2.0,
               main_window.SCREEN_HEIGHT - 75 + font->spacing_y / 4.0, msg, "ui_0");

    font->show((main_window.SCREEN_WIDTH - load_message.length() * font->spacing_x) / 2.0,
               main_window.SCREEN_HEIGHT - 75 + font->spacing_y * 2.0, load_message, "ui_0");
