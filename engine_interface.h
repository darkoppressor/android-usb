...
class Version_Series {
    public:
        ...
        Version_Series (int get_major_1, int get_minor_1, int get_micro_1, int get_major_2, int get_minor_2,
                        int get_micro_2);
};
...
class Engine_Interface {
    public:
        ...
        // Pass CONTROLLER_ID_TOUCH for controller_number to check if the touch controller has the passed button
        // pressed.
        ...
        // Returns true if the version of the passed profile is in the same series of compatible releases as the current
        // version.
