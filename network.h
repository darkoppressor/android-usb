...
class Network {
    public:
        ...
        // Keeps track of each passing second and resets client update counts (server) or command packet counts
        // (client).
        Timer timer_tick;
        ...
        void add_server(std::string get_name, std::string get_address, unsigned short get_port,
                        std::string get_password);
        void remove_server(int index);
        void edit_server(int index, std::string get_name, std::string get_address, unsigned short get_port,
                         std::string get_password);
