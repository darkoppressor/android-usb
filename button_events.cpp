...
bool Button_Events::handle_button_event (string button_event, Window* parent_window) {
    ...
    if (button_event.length() > 0) {
        if (button_event == "close_window") {
            ...
            if (parent_window != 0) {
                network.add_server(parent_window->get_info_text(0), parent_window->get_info_text(1),
                                   string_stuff.string_to_unsigned_long(parent_window->get_info_text(2)),
            ...
            if (parent_window != 0) {
                network.edit_server(engine_interface.editing_server, parent_window->get_info_text(0),
