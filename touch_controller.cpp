...
void Touch_Controller::render () {
    ...
    render_texture(anchor_dpad.x * scale_x - anchor_dpad.r * scale_mean,
                   anchor_dpad.y * scale_y - anchor_dpad.r * scale_mean, *image_dpad,
                   engine_interface.option_touch_controller_opacity, scale_anchor_dpad * scale_mean,
                   scale_anchor_dpad * scale_mean);

    if (engine_interface.touch_controller_xy) {
        Image_Data* image_main = image.get_image("touch_controller_main");

        render_texture(anchor_main.x * scale_x - anchor_main.r * scale_mean,
                       anchor_main.y * scale_y - anchor_main.r * scale_mean, *image_main,
                       engine_interface.option_touch_controller_opacity, scale_anchor_main * scale_mean,
                       scale_anchor_main * scale_mean);
    } else {
    ...
    if (engine_interface.touch_controller_shoulders) {
        ...
        render_texture(shoulder_left.x * scale_x - shoulder_left.r * scale_mean,
                       shoulder_left.y * scale_y - shoulder_left.r * scale_mean, *image_shoulder_left,
                       engine_interface.option_touch_controller_opacity, scale_shoulders * scale_mean,
                       scale_shoulders * scale_mean);

        Image_Data* image_shoulder_right = image.get_image("touch_controller_shoulder_right");

        render_texture(shoulder_right.x * scale_x - shoulder_right.r * scale_mean,
    ...
    if (engine_interface.touch_controller_guide) {
        ...
        render_texture(anchor_middle.x * scale_x, anchor_middle.y * scale_y, *image_middle,
                       engine_interface.option_touch_controller_opacity, scale_anchor_middle_x * scale_x,
                       scale_anchor_middle_y * scale_y);
    } else {
